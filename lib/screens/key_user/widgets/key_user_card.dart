...
class KeyUserCard extends StatelessWidget {
  final KeyUser keyUser;
          ...
          children: [
            ...
            SizedBox(
              ...
              child: Container(
                ...
                child: keyUser.profilePicture != null && keyUser.profilePicture!.isNotEmpty
                    ? GestureDetector(
                        onTap: () => FullScreenImageViewer.show(context, keyUser.profilePicture!),
                        child: ClipRRect(
                          borderRadius: const BorderRadius.horizontal(left: Radius.circular(12)),
                          child: Image.network(
                            keyUser.profilePicture!,
                            fit: BoxFit.cover,
                    ...
                    : const Center(child: Icon(Icons.person_pin, color: AppColor.textHint, size: 40)),
              ),
            ),
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                'User Code: ${keyUser.userCode ?? '-'}',
                                style: const TextStyle(color: AppColor.textSecondary, fontSize: 12),
                              ),
                              Text(
                                'BP Code: ${keyUser.bpCode?.split('-').first.trim() ?? '-'} -${keyUser.bpName}',
                                style: const TextStyle(color: AppColor.textSecondary, fontSize: 12),
                              ),
                            ],
                          ),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            ...
                            style: TextStyle(
                              color: keyUser.status == "1" ? AppColor.success : AppColor.error,
                              fontSize: 11,

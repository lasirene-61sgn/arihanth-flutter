class CraftsmanAadharDetail {
  final int? id;
  final String? aadharName;
  final String? aadharNumber;
  final String? aadharImageUrl;

  CraftsmanAadharDetail({this.id, this.aadharName, this.aadharNumber, this.aadharImageUrl});

  factory CraftsmanAadharDetail.fromJson(Map<String, dynamic> json) {
    return CraftsmanAadharDetail(
      id: json['id'],
  ...
  CraftsmanAadharDetail copyWith({
    int? id,
    String? aadharName,
    String? aadharNumber,
...
class CraftsmanPanDetail {
  final int? id;
  final String? panNumber;
  final String? panImageUrl;

  CraftsmanPanDetail({this.id, this.panNumber, this.panImageUrl});

  factory CraftsmanPanDetail.fromJson(Map<String, dynamic> json) {
    return CraftsmanPanDetail(
      id: json['id'],
...
class CraftsmanBankDetail {
  ...
  factory CraftsmanBankDetail.fromJson(Map<String, dynamic> json) {
    return CraftsmanBankDetail(
      id: json['id'],
...
class CraftsmanWorkerInfo {
  final int? id;
  final String? workerName;
  final String? workerNumber;
  final String? workerImageUrl;

  CraftsmanWorkerInfo({this.id, this.workerName, this.workerNumber, this.workerImageUrl});

  factory CraftsmanWorkerInfo.fromJson(Map<String, dynamic> json) {
    return CraftsmanWorkerInfo(
      id: json['id'] ?? 0,
      workerName: json['worker_name'],
      workerNumber: json['worker_number'],
      workerImageUrl: json['worker_image_url'] ?? json['image'],
    );
  }

  CraftsmanWorkerInfo copyWith({
    int? id,
    String? workerName,
    String? workerNumber,
    ...
    return CraftsmanWorkerInfo(
      ...
      workerNumber: workerNumber ?? this.workerNumber,
      workerImageUrl: workerImageUrl ?? this.workerImageUrl,
    );
  }
}

class CraftsmanProfileModel {
  final int id;
  ...
  final List<CraftsmanAadharDetail> aadharDetails;
  final List<CraftsmanPanDetail> panDetails;
  final List<CraftsmanBankDetail> bankDetails;
  final List<CraftsmanWorkerInfo> workers;

  final int? isFrozen;
  final String? kycStatus;

  CraftsmanProfileModel({
    required this.id,
    this.craftmanCode,
    this.businessName,
    this.name,
  ...
  factory CraftsmanProfileModel.fromJson(Map<String, dynamic> json) {
    return CraftsmanProfileModel(
      id: json['id'] ?? 0,
      craftmanCode: json['craftman_code'] ?? json['bp_code'],
      ...
      aadharDetails: (json['aadhar_details'] as List?)?.map((e) => CraftsmanAadharDetail.fromJson(e)).toList() ?? [],
      panDetails: (json['pan_details'] as List?)?.map((e) => CraftsmanPanDetail.fromJson(e)).toList() ?? [],
      bankDetails: (json['bank_details'] as List?)?.map((e) => CraftsmanBankDetail.fromJson(e)).toList() ?? [],
      workers: (json['workers'] as List?)?.map((e) => CraftsmanWorkerInfo.fromJson(e)).toList() ?? [],
      isFrozen: json['is_frozen'] is int ? json['is_frozen'] : (int.tryParse(json['is_frozen']?.toString() ?? '')),
      kycStatus: json['kyc_status'],
    );
  }

  CraftsmanProfileModel copyWith({
    int? id,
    String? craftmanCode,
    String? businessName,
    String? name,
    ...
    List<CraftsmanAadharDetail>? aadharDetails,
    List<CraftsmanPanDetail>? panDetails,
    List<CraftsmanBankDetail>? bankDetails,
    List<CraftsmanWorkerInfo>? workers,
    int? isFrozen,
    String? kycStatus,
  }) {
    return CraftsmanProfileModel(

...
import 'po_sub_item_row.dart';

class POItemRow extends StatelessWidget {
  final int index;
  final Map<String, dynamic> itemData;
  final Widget categoryDropdown;
  final Widget subCategoryDropdown;
  final Widget designField;
  final Widget imageWidget; // This is the image picker/preview widget
  ...
  // Helper for consistent small input look (used for Notes and Total Weight)
  Widget _smallTextField({required TextEditingController controller, required String hint, bool readOnly = false}) {
    return Container(
      height: 38,
  ...
  Widget _buildWebRow(BuildContext context) {
    ...
    final List<PlatformFile> selectedFiles = itemData['selectedFiles'] ?? [];
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          // Dropdowns & Design
          SizedBox(width: 130, child: categoryDropdown),
          const SizedBox(width: colSpacing),
          SizedBox(width: 130, child: subCategoryDropdown),
          const SizedBox(width: colSpacing),
          SizedBox(width: 130, child: designField),
          const SizedBox(width: colSpacing),
              ...
              children: [
                ...
                if (selectedFiles.isNotEmpty) 
                  const Padding(
                    ...
                    child: Text('Click to change', style: TextStyle(fontSize: 9, color: AppColor.textSecondary)),
                  ),
              ],
            )
          ),
            ...
            SizedBox(
              ...
              child: Column(
                children: [
                  ...
                  if (selectedFiles.isNotEmpty) ...[
                    const SizedBox(height: 8),
                    _buildImageThumbnails(selectedFiles),
                  ]
                ],
              )
            ),
